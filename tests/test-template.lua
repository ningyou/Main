...
context('Library: Template', function()
	context('static template', function()
		test('simple', function()
			...
			assert_equal(gen, prepend .. "_O:write[=[<p>Simple</p>]=]")
		end)
	...
	context('dynamic template', function()
		context('variable', function()
			test('single', function()
				...
				assert_equal(gen, prepend .. '_O:write(var)')
			end)
		...
		context('snippet', function()
			test('single line', function()
				...
				assert_equal(gen, prepend .. 'if(true) then end')
			end)
			...
			test('multi line', function()
				...
				assert_equal(gen, prepend .. 'if(true) then\nend')
			end)
